            ...
            function: {
                ...
                parameters: {
                    ...
                    properties: {
                        twinLimits: { 
                            type: "object", 
                            description: "The usage limits for each app in seconds. Example: {\"com.facebook.katana\": 30, \"com.instagram.android\": 20, \"com.snapchat.android\": 10, \"com.reddit.frontpage\": 25, \"com.android.chrome\": 0, \"com.twitter.android\": 0}" 
                        }
                    },
                    required: ['twinLimits']
                }
